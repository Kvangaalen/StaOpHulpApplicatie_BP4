...
public class AdapterClientOverzicht extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {

    private ArrayList<ZorgpersoneelClient> items = new ArrayList<>();
    private Context ctx;
    private OnItemClickListener onItemClickListener;
    private OnMoreButtonClickListener onMoreButtonClickListener;
    private AdapterClientOverzicht.OnItemLongClickListener OnItemLongClickListener;
    public AdapterClientOverzicht(Context context, List<ZorgpersoneelClient> items) {
    ...
    public interface OnItemLongClickListener{
        void onItemClick(ViewHolder view, ZorgpersoneelClient obj, int item);
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.client_row, parent, false);
        vh = new ViewHolder(v);
        return vh;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (holder instanceof ViewHolder) {
            ...
            view.personeelnummer.setText(String.valueOf(o.getClientnummer()));
            DatabaseHelper dbH = new DatabaseHelper(ctx.getApplicationContext());
            SQLiteDatabase db = dbH.getReadableDatabase();
            String sql = "select * from " + DataContract.Gebruiker.TABLE_Gebruikers + " Where  gebruikersnummer = '" + o.getClientnummer() + "'";
