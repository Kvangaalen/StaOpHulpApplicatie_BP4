...
public class AdapterZorgpersoneel extends RecyclerView.Adapter < RecyclerView.ViewHolder > implements View.OnClickListener {
    ...
    public AdapterZorgpersoneel(Context context, List < ZorgpersoneelClient > items) {
        this.items = (ArrayList < ZorgpersoneelClient > ) items;
        ctx = context;
    }

    public void setOnItemClickLongListener(AdapterZorgpersoneel.OnItemClickListener OnItemClickLongListener) {
